...
import '../pages/property_community_statistics.dart';

class WidgetProperty extends StatefulWidget {
  const WidgetProperty({super.key});

  @override
  State<WidgetProperty> createState() => _WidgetCommunityState();
}

class _WidgetCommunityState extends State<WidgetProperty> {
  int selectedType = 0;
